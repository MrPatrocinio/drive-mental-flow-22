...
-- Proteger dados de business: Melhorar políticas da tabela background_music
-- Remove política insegura se existir
DROP POLICY IF EXISTS "Everyone can view background music" ON public.background_music;

-- Política mais restritiva: apenas usuários autenticados podem ver música de fundo
